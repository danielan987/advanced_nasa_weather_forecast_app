...
## Summary
Most people schedule their trips months in advance and then worry about how the weather might affect their upcoming trips. This underscores the need for a long-term weather forecast. Leveraging 40 years of NASA Earth data, this app can predict weather patterns 365 days into the future. This app can also visualize historical data, trends, and seasonal cycles. Providing users with insights to prepare for their trips. 
